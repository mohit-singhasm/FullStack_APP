...
const SideBar = () => {
  ...
  return (
    <>
      ...
      <aside
        id="default-sidebar"
        className={`sticky h-[100vh] top-0 left-0 z-40 flex transition-[width] ${
      ...
      >
        <button
          ...
          onClick={changeSideBar}
        >
          {!openSideBar ? <FaArrowRight /> : <FaArrowLeft />}
        </button>
        <div className="h-full w-full px-3 py-3 overflow-y-auto bg-primary">
          <a
            href="#"
          ...
          >
            <RiDashboard2Fill className="text-3xl shrink-0" />
            {/* <span className="ms-3">Dashboard</span> */}
            {openSideBar ? <span className="ms-3">Dashboard</span> : null}
          </a>
          ...
          <ul className="space-y-2 font-medium my-8">
            <li>
              <Link
                ...
                to="/admin/users"
              >
                <FaUsers className="text-2xl shrink-0" />
                {/* <span className="ms-3">Dashboard</span> */}
                {openSideBar ? <span className="ms-3">Users</span> : null}
              </Link>
            </li>
      ...
      {/* <div className={`p-4 sm:ml-64 w-full h-full ${openSideBar? "absolute" : "hidden"}`} onClick={changeSideBar}>.</div> */}
    </>
  );
};
